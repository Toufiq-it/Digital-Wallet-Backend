...
const checkAuth = (...authRoles) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // jwt token verified
        const verifiedToke = (0, jwt_1.verifyToken)(accessToken, env_1.envVars.JWT_ACCESS_SECRET);
        // console.log("Decoded token in middleware:", verifiedToke);
        // phone check
        const isUserExist = yield user_model_1.User.findOne({ phone: verifiedToke.phone });
        // user validetion
        if (!isUserExist) {
